...
export const Header = ({linksTree, searchItems}: {linksTree?: LinkTree[]; searchItems: SearchItem[]}) => {
...
export function ContentLayout({linksTree, searchItems, children}: ContentLayoutProps) {
  return (
